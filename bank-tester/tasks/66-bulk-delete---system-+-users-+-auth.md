...
3. **Bulk delete** using `pfsense_delete_system_tunables` with `confirm=True` — delete ALL resources in this collection
...
6. **Bulk delete** using `pfsense_delete_system_certificate_authorities` with `confirm=True` — delete ALL resources in this collection
...
9. **Bulk delete** using `pfsense_delete_system_certificates` with `confirm=True` — delete ALL resources in this collection
...
12. **Bulk delete** using `pfsense_delete_system_cr_ls` with `confirm=True` — delete ALL resources in this collection
...
16. **Bulk delete** using `pfsense_delete_users` with `confirm=True` — delete ALL resources in this collection
...
20. **Bulk delete** using `pfsense_delete_user_groups` with `confirm=True` — delete ALL resources in this collection
...
24. **Bulk delete** using `pfsense_delete_user_auth_servers` with `confirm=True` — delete ALL resources in this collection
...
27. **Bulk delete** using `pfsense_delete_auth_keys` with `confirm=True` — delete ALL resources in this collection
...
30. **Bulk delete** using `pfsense_delete_diagnostics_config_history_revisions` with `confirm=True` — delete ALL resources in this collection
